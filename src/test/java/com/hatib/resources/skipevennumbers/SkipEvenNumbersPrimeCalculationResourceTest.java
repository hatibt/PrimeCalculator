 ...
 */
public class SkipEvenNumbersPrimeCalculationResourceTest {

    @Rule
    public final ResourceTestRule resources = ResourceTestRule.builder()
            .addResource(new SkipEvenNumbersCalculatorResource())
    ...
    public void testInvalidRequestPrimeNumberPositionMissing() {
        Response response = resources.getJerseyTest().target("/primes/skipevennumbers/calculate/").request().buildGet().invoke();
    ...
    public void testInvalidRequestPrimeNumberPositionIsNotANumber() {
        Response response = resources.getJerseyTest().target("/primes/skipevennumbers/calculate/A").request().buildGet().invoke();
        Assert.assertEquals(response.getStatus(), 404);
    }
    ...
    public void testValidRequestPrimeNumberPositionIsAnInteger() {
        final Response response = resources.getJerseyTest().target("/primes/skipevennumbers/calculate/99").request().buildGet().invoke();
    ...
    public void testValidRequestPrimeNumberPositionIsTooLargeToBeAnInteger() {
        Response response = resources.getJerseyTest().target("/primes/skipevennumbers/calculate/9999999999999999999999999").request().buildGet().invoke();
        Assert.assertEquals(response.getStatus(), 404);
    }
